...
class SpecificChildAdapter(private val studentName: String) :
    ListAdapter<ChildrenActivity, SpecificChildAdapter.SpecificRoomViewHolder>(SpecificChildDiffUtil()) {

    class SpecificRoomViewHolder(private val itemActivityBinding: LayoutItemActivityBinding) :
    ...
    class SpecificChildDiffUtil : DiffUtil.ItemCallback<ChildrenActivity>() {
        override fun areItemsTheSame(
            oldItem: ChildrenActivity,
            newItem: ChildrenActivity
        ): Boolean {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SpecificRoomViewHolder {
        ...
        return SpecificRoomViewHolder(
            LayoutItemActivityBinding.inflate(
                layoutInflater,
                parent,
                false
            )
