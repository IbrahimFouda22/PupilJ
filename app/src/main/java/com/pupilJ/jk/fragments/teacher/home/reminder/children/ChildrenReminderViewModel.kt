...
class ChildrenReminderViewModel @AssistedInject constructor(
    ...
    interface AssistedFactory {
        fun create(id: Int,roomName: String): ChildrenReminderViewModel
    }

    companion object {
        fun childrenReminderViewModelFactory(
